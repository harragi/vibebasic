...
const Terminal = () => {
  const [lines, setLines] = useState([
    { text: 'VibeBASIC 1.0 🎵', type: 'system' },
    { text: 'Feel the Retro Vibe with Modern Sound!', type: 'system' },
    { text: '© 2025 VibeBASIC - Educational Use Only', type: 'system' },
