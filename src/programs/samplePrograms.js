...
180 END`
  ...
  'MUSIC.BAS': {
    name: 'Music Notes',
    description: 'Simple music player with BEEP sounds',
    code: `10 REM SIMPLE MUSIC PLAYER - BEEP DEMONSTRATION
20 PRINT "PLAYING A SIMPLE MELODY..."
30 PRINT "NOTE: Make sure your volume is on!"
35 PRINT
40 DATA 262, 294, 330, 349, 392, 440, 494, 523
50 FOR I = 1 TO 8
60 READ F
70 PRINT "♪ NOTE FREQUENCY:"; F; "HZ"
80 BEEP F, 400
90 REM Wait for note to finish plus gap
100 FOR D = 1 TO 500: NEXT D
110 NEXT I
120 RESTORE
130 PRINT
140 PRINT "PLAYING SCALE BACKWARDS..."
150 FOR D = 1 TO 300: NEXT D
160 DATA 523, 494, 440, 392, 349, 330, 294, 262
170 FOR I = 1 TO 8
180 READ F
190 BEEP F, 300
200 REM Wait for note to finish
210 FOR D = 1 TO 400: NEXT D
220 NEXT I
230 PRINT
240 PRINT "MELODY COMPLETE!"
250 END`
  },

  'BEEPTEST.BAS': {
    name: 'BEEP Test',
    description: 'Test various BEEP frequencies and durations',
    code: `10 REM BEEP COMMAND TEST PROGRAM
20 CLS
30 PRINT "BEEP SOUND TEST"
40 PRINT "==============="
50 PRINT
60 PRINT "1. SIMPLE BEEP (DEFAULT)"
70 BEEP
80 FOR D = 1 TO 300: NEXT D
90 PRINT "   ♪ Standard beep (800Hz, 200ms)"
100 FOR D = 1 TO 200: NEXT D
110 PRINT
120 PRINT "2. LOW FREQUENCY BEEP"
130 BEEP 200, 500
140 FOR D = 1 TO 700: NEXT D
150 PRINT "   ♪ Low tone (200Hz, 500ms)"
160 FOR D = 1 TO 200: NEXT D
170 PRINT
180 PRINT "3. HIGH FREQUENCY BEEP"
190 BEEP 1500, 300
200 FOR D = 1 TO 500: NEXT D
210 PRINT "   ♪ High tone (1500Hz, 300ms)"
220 FOR D = 1 TO 200: NEXT D
230 PRINT
240 PRINT "4. RAPID BEEPS"
250 FOR I = 1 TO 5
260 BEEP 1000, 100
270 FOR D = 1 TO 200: NEXT D
280 NEXT I
290 PRINT "   ♪ 5 rapid beeps"
300 FOR D = 1 TO 200: NEXT D
310 PRINT
320 PRINT "5. ASCENDING TONES"
330 FOR F = 400 TO 800 STEP 100
340 BEEP F, 200
350 FOR D = 1 TO 300: NEXT D
360 NEXT F
370 PRINT "   ♪ Ascending frequency"
380 FOR D = 1 TO 200: NEXT D
390 PRINT
400 PRINT "6. SIMPLE MELODY"
410 DATA 523, 523, 587, 523, 698, 659
420 DATA 523, 523, 587, 523, 784, 698
430 DATA 523, 523, 1046, 880, 698, 659, 587
440 FOR I = 1 TO 19
450 READ N
460 BEEP N, 300
470 FOR D = 1 TO 350: NEXT D
480 NEXT I
490 PRINT "   ♪ Happy tune!"
500 PRINT
510 PRINT "TEST COMPLETE!"
520 END`
  },

  'GATES.BAS': {
    name: 'Tech Pioneer ASCII Art',
    description: 'ASCII portrait - Educational demonstration',
    code: `10 REM TECH PIONEER - GRADIENT PORTRAIT 1985
20 CLS
30 PRINT "LOADING TECH PIONEER PORTRAIT..."
40 PRINT "Educational ASCII Art Demo"
...
690 END`
  ...
  'JOBS.BAS': {
    name: 'Tech Innovator ASCII Art',
    description: 'ASCII portrait - Educational demonstration',
    code: `10 REM TECH INNOVATOR - GRADIENT PORTRAIT 1985
20 CLS
30 PRINT "LOADING TECH INNOVATOR PORTRAIT..."
40 PRINT "Educational ASCII Art Demo"
50 FOR D = 1 TO 1000: NEXT D
60 CLS
70 REM BEGIN PORTRAIT DISPLAY
